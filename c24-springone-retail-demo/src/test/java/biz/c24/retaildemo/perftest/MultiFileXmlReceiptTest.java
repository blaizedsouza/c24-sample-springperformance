...
@Configuration
public class MultiFileXmlReceiptTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ApplicationContext parentContext = new AnnotationConfigApplicationContext(MultiFileXmlReceiptTest.class);
        GenericXmlApplicationContext context = new GenericXmlApplicationContext();
        context.setParent(parentContext);
        context.load("classpath:receipts/receipt-format-xml.xml");
        context.load("classpath:receipts/receipt-transport-multifile.xml");
        context.refresh();
